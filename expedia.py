...
def parse(url):
    ...
    response = webdriver.Chrome(r'C:\Users\KIIT\Downloads\chromedriver.exe')
    response.get(url)
    ...
    hotels = parser.xpath('//*[@id="app"]/div[1]/div/div/div/div[1]/main/div/section[2]/ol/li[1]/div/div')
    for hotel in hotels[:]: #Replace 5 with 1 to just get the cheapest hotel
        ...
        price = hotel.xpath('//*[@id="app"]/div[1]/div/div/div/div[1]/main/div/section[2]/ol/li[2]/div/div/div/div[2]/div[1]/div[1]/span/span[2]')
